...
namespace RE
{
	...
	public:
		...
		{
			REL::Relocation<FlatScreenModel**> singleton{ REL::ID(4801718) };
			return *singleton;
		}
	...
	public:
		void UpdateDataModels()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2220905) };
			return func(this);
		}
	};
	...
	public:
		...
		bool ShouldHandleEvent(const InputEvent* a_event) override  // 01
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2287392) };
		...
		void HandleEvent(const ButtonEvent* a_event) override  // 08
		{
			if (menuObj.IsObject()) {
				...
				REL::Relocation<func_t> func{ REL::ID(2287393) };
				return func(this, a_event);
			}
		}
		...
		virtual bool PassesRenderConditionText(MENU_RENDER_CONTEXT a_reason, const BSFixedString& a_customRendererName) const  // 07
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2287379) };
		...
		void OnSetSafeRect()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2287375) };
			return func(this);
		}
		...
		UI_MESSAGE_RESULTS ProcessScaleformEvent(Scaleform::GFx::Movie* a_movie, const IUIMessageData* a_data)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2287395) };
		...
		void RefreshPlatform()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2287374) };
			return func(this);
		}
	...
	public:
		...
		Scaleform::GFx::Value* AcquireFlashObjectByPath(const Scaleform::GFx::Movie& a_parentMovie, const char* a_absolutePathToMember)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2287015) };
	...
	public:
		...
		virtual BSEventNotifyControl ProcessEvent(const ApplyColorUpdateEvent& a_event, BSTEventSource<ApplyColorUpdateEvent>* a_source) override  // 01
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2287033) };
	...
	public:
		...
		virtual void SetIsTopButtonBar(bool a_isTopButtonBar) override  // 08
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2223204) };
		...
		virtual void OnMenuDisplayStateChanged() override  // 0A
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2223205) };
			return func(this);
		}
		...
		virtual bool CacheShaderFXQuadsForRenderer_Impl() override  // 10
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2223200) };
			return func(this);
		}
		...
		virtual void TransferCachedShaderFXQuadsForRenderer(const BSFixedString& a_rendererName) override  // 11
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2223201) };
		...
		virtual void SetViewportRect(const NiRect<float>& a_viewportRect) override  // 12
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2223202) };
		...
		virtual void AppendShaderFXInfos(BSTAlignedArray<UIShaderFXInfo>& a_colorFXInfos, BSTAlignedArray<UIShaderFXInfo>& a_backgroundFXInfos) const  // 13
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2223203) };
		...
		void SetUpButtonBar(BSGFxShaderFXTarget& a_parentObject, const char* a_buttonBarPath, HUDColorTypes a_colorType)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2223197) };
	...
	public:
		...
		{
			REL::Relocation<ObjectRefHandle*> ref{ REL::ID(2701395) };
			return *ref;
		}

		[[nodiscard]] static decltype(auto) GetPickRefs()
		{
			REL::Relocation<BSTArray<ObjectRefHandle>*> pickRefs{ REL::ID(2701391) };
			return *pickRefs;
		}
	...
	public:
		...
		void CheckAndSetItemForPlacement()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2224991) };
			return func(this);
		}
		...
		void UpdateButtonText()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2224992) };
			return func(this);
		}
	...
	public:
		...
		BSEventNotifyControl ProcessEvent(const PipboyValueChangedEvent& a_event, BSTEventSource<PipboyValueChangedEvent>* a_source) override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2224270) };
			return func(this, a_event, a_source);
		}
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2224261) };
			return func(this);
		}
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2224256) };
			return func(this);
		}
	};
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2224224) };
			return func(this);
		}
	};
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2224143) };
			return func(this);
		}
	};
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2224231) };
			return func(this);
		}
	};
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2224273) };
			return func(this);
		}
	};
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2224052) };
			return func(this);
		}
	};
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2224074) };
			return func(this);
		}
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2224242) };
			return func(this);
		}
	...
	public:
		...
		void UpdateData() override
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2224248) };
			return func(this);
		}
	};
	...
	public:
		...
		public:
			...
			void IncrementSort()
			{
				...
				REL::Relocation<func_t> func{ REL::ID(2222848) };
				return func(this);
			}
	...
	public:
		...
		void TakeAllItems()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2248619) };
			return func(this);
		}
	...
	public:
		...
		void ClearTradingData()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2222700) };
			return func(this);
		}
		...
		void CompleteTrade()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2222701) };
			return func(this);
		}
		...
		[[nodiscard]] std::int64_t GetCapsOwedByPlayer()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2222714) };
			return func(this);
		}
	...
	public:
		...
		void ShowMessage()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2249469) };
			return func(this);
		}
	...
	public:
		...
		void BuildWeaponScrappingArray()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2223077) };
			return func(this);
		}
		...
		[[nodiscard]] std::uint32_t GetSelectedIndex()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2223022) };
			return func(this);
		}
		...
		void ShowConfirmMenu(ExamineConfirmMenu::InitData* a_data, ExamineConfirmMenu::ICallback* a_callback)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2223081) };
	...
	public:
		...
		static void OpenLockpickingMenu(TESObjectREFR* a_lockedRef)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2249263) };
