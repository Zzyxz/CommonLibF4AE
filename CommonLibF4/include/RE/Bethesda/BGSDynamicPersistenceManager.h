...
namespace RE
{
	...
	public:
		...
		{
			REL::Relocation<BGSDynamicPersistenceManager**> singleton{ REL::ID(4796312) };
			return *singleton;
		}
		...
		bool PromoteReference(TESObjectREFR* a_refr, TESForm* a_owner)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2193819) };
		...
		bool DemoteReference(TESObjectREFR* a_refr, TESForm* a_owner, bool a_allowActors = false)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2193820) };
