...
namespace RE
{
	...
	public:
		...
		{
			REL::Relocation<EventSource_t**> singleton{ REL::ID(2707340) };
			if (!*singleton) {
	...
	public:
		...
		[[nodiscard]] static EventSource_t* GetEventSource()
		{
			REL::Relocation<EventSource_t**> singleton{ REL::ID(4802332) };
			if (!*singleton) {
				*singleton = new EventSource_t(&BSTGlobalEvent::GetSingleton()->eventSourceSDMKiller);
			}
			return *singleton;
	...
	public:
		[[nodiscard]] static EventSource_t* GetEventSource()
		{
			REL::Relocation<EventSource_t**> singleton{ REL::ID(4803487) };
			if (!*singleton) {
				*singleton = new EventSource_t(&BSTGlobalEvent::GetSingleton()->eventSourceSDMKiller);
			}
			return *singleton;
	...
	public:
		[[nodiscard]] static EventSource_t* GetEventSource()
		{
			REL::Relocation<EventSource_t**> singleton{ REL::ID(4802833) };
			if (!*singleton) {
				*singleton = new EventSource_t(&BSTGlobalEvent::GetSingleton()->eventSourceSDMKiller);
			}
			return *singleton;
	...
	private:
			...
			const InventoryUserUIInterfaceEntry& a_entry)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2222612) };
	...
	public:
		...
		[[nodiscard]] static BSTEventSource<LocksPicked::Event>* GetEventSource()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2249292) };
			return func();
		}
	};
	...
	public:
		...
		[[nodiscard]] static EventSource_t* GetEventSource()
		{
			REL::Relocation<EventSource_t**> singleton{ REL::ID(4804734) };
			if (!*singleton) {
				*singleton = new EventSource_t(&BSTGlobalEvent::GetSingleton()->eventSourceSDMKiller);
			}
			return *singleton;
	...
	public:
		[[nodiscard]] static EventSource_t* GetEventSource()
		{
			REL::Relocation<EventSource_t**> singleton{ REL::ID(4803571) };
			if (!*singleton) {
				*singleton = new EventSource_t(&BSTGlobalEvent::GetSingleton()->eventSourceSDMKiller);
			}
			return *singleton;
	...
	public:
		[[nodiscard]] static BSTEventSource<TESActivateEvent>* GetEventSource()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2201819) };
			return func();
		}
	...
	public:
		[[nodiscard]] static BSTEventSource<TESStealEvent>* GetEventSource()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2233732) };
			return func();
		}
	...
	public:
		[[nodiscard]] static BSTEventSource<TESContainerChangedEvent>* GetEventSource()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2201832) };
			return func();
		}
	...
	public:
		...
		[[nodiscard]] static BSTEventSource<TESFurnitureEvent>* GetEventSource()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2201844) };
			return func();
		}
	...
	public:
		[[nodiscard]] static BSTEventSource<TESMagicEffectApplyEvent>* GetEventSource()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2201851) };
			return func();
		}
	...
	public:
		[[nodiscard]] static BSTEventSource<TESObjectLoadedEvent>* GetEventSource()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2201853) };
			return func();
		}
	...
	public:
		[[nodiscard]] static BSTEventSource<TESEquipEvent>* GetEventSource()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2201838) };
			return func();
		}
	...
	public:
		[[nodiscard]] static BSTEventSource<TESHitEvent>* GetEventSource()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2201886) };
			return func();
		}
