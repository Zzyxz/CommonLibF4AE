...
namespace RE
{
	...
	public:
		...
		{
			REL::Relocation<BGSStoryEventManager**> singleton{ REL::ID(4800796) };
			return *singleton;
		}
	...
	public:
		...
		[[nodiscard]] static std::uint32_t EVENT_INDEX()
		{
			REL::Relocation<std::uint32_t*> eventIdx{ REL::ID(2663410) };
			return *eventIdx;
		}
	...
	private:
		BGSPickLockEvent* ctor(TESObjectREFR* a_actor, TESObjectREFR* a_lockRef, bool a_isCrime)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2214021) };
