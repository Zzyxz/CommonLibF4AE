...
namespace RE
{
	...
	public:
		[[nodiscard]] bool StartThrow()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2216044) };
			return func(this);
		}
		...
		[[nodiscard]] bool CheckShouldThrow() const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2216045) };
			return func(this);
		}
		...
		[[nodiscard]] float CalcThrowChance() const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2216046) };
			return func(this);
		}
	};
	...
	public:
		[[nodiscard]] bool CheckShouldStop(float a_distance)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2242176) };
		...
		[[nodiscard]] bool CheckShouldDistract() const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2242177) };
			return func(this);
		}
	};
	...
	public:
		[[nodiscard]] bool IsActorACombatTarget(Actor* a_actor) const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2216394) };
		...
		[[nodiscard]] bool IsFighting() const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2216397) };
			return func(this);
		}
		...
		[[nodiscard]] bool IsFleeing() const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2216398) };
			return func(this);
		}
		...
		[[nodiscard]] bool IsSearching() const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2216399) };
			return func(this);
		}
		...
		void SetTarget(Actor* a_target)
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2216401) };
			func(this, a_target);
		}
		...
		[[nodiscard]] bool CanChangeTarget() const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2216402) };
			return func(this);
		}
		...
		void UpdateCurrentCombatStyle()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2216407) };
			func(this);
		}
		...
		void ClearStance()
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2216411) };
			func(this);
		}
		...
		[[nodiscard]] bool CheckLOS(const ActorStance& a_stance, const NiPoint3& a_target) const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2216431) };
		...
		[[nodiscard]] bool CheckLOS(const ActorStance& a_stance, const NiPoint3& a_source, const NiPoint3& a_target) const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2216432) };
		...
		[[nodiscard]] bool ChooseBestMovementDirection(const NiPoint3& a_direction, const NiPoint3& a_target, float a_distance) const
		{
			...
			REL::Relocation<func_t> func{ REL::ID(2216453) };
